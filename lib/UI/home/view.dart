                      ...
                      Container(
                        ...
                        child: ListView(
                            ...
                            children: [
                              Padding(
                                padding:
                                    EdgeInsets.only(bottom: 28.0.h, top: 20.h),
                                child: BaseText(
                              ...
                              Padding(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemCount: model.homeWidgetList
                                ...
                                builder: (context, snapshot) => snapshot.hasData
                                    ? Visibility(
                                        visible: snapshot.data!.myPlan ==
                                                null ||
                                            (snapshot.data!.myPlan != null &&
                                                snapshot.data!.myPlan!.status !=
                                                    1),
                                        child: Padding(
                                          padding: EdgeInsets.only(
                                              top: 17.h, bottom: 10.h),
                                          child: Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment.spaceBetween,
                                            children: [
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            RichText(
                                                                              text: TextSpan(
                                                                                ...
                                                                                children: [
                                                                                  TextSpan(
                                                                                    style: TextStyle(color: black, fontWeight: FontWeight.w400, fontSize: 10.sp),
                                                                                    text: 'Month',
                                                                                  ),
                                                                                ],
                                                                              ),
