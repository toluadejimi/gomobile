        ...
        tab: Scaffold(
          ...
          body: SafeArea(
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      decoration: BoxDecoration(
                                        color: primaryColor, // Set the background color to yellow
                            ...
                            Row(
                              children: [
                                SvgPicture.asset('assets/images/svg/solar_wallet-bold.svg',
                                  height:24,width: 24,
                                ),
                    ...
                    const Padding(
                      ...
                      child: BaseText('What would you like to do today ?',
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        ),
                    ),
                ...
                child: Row(children: [
                  SvgIconInCircle(svgAssetPath: 'assets/images/svg/number.svg',),
                  Padding(
                    ...
                    child: Column(
                      ...
                      child: BaseText('Reserve Phone Number',
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      ),
                    ),
                    BaseText('Rent a phone number to \ncall and text family and friends',
                    fontSize: 16,
                      color: grey,
                    ),
                      ],
