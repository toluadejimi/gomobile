...
import 'package:flutter_contacts/contact.dart' as _i25;
...
class HomeViewArguments {
  ...
  final _i24.PageController pageController;
...
class DeviceContactViewArguments {
  ...
  final void Function(_i25.Contact) click;
...
extension NavigatorStateExtension on _i26.NavigationService {
  ...
  Future<dynamic> navigateToHomeView({
    _i24.Key? key,
    required _i24.PageController pageController,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToDeviceContactView({
    ...
    required void Function(_i25.Contact) click,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
